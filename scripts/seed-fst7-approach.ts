...
const fst7Approach = {
  ...
  level_notes: {
    it: 'Richiede buona connessione mente-muscolo e tolleranza al pump',
    en: 'Requires good mind-muscle connection and pump tolerance'
  },
    ...
    if (existing) {
      ...
      result = await supabase
        ...
        .update({
          ...
          category: fst7Approach.category,
          recommended_level: fst7Approach.recommended_level,
          level_notes: fst7Approach.level_notes,
